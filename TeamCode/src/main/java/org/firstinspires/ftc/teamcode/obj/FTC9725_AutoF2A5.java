...
@Autonomous(name="FTC9725 Test: Auto Mode F2A5", group="Test Robot")


public class FTC9725_AutoF2A5 extends LinearOpMode {
    ...
    // 0.5 power = 905 milliseconds to turn 90º
    ...
    public void runOpMode() {
        ...
        robot.driveRobot(0,0,0);
        safeWait(300);
        // turns robot to face basket counterclockwise

        robot.driveRobot(0,-0.5,0);
        safeWait(700);
        robot.driveRobot(0,0,0);
        safeWait(300);
        //moves robot laterally to avoid running into the samples

        robot.elbow.setPower(0.8);
        robot.elbow.setTargetPosition(-382); //change to desired point
        ...
        telemetry.addData("Elbow Position:", robot.elbow.getCurrentPosition());
        telemetry.update();
        sleep(1000);
    }
}
